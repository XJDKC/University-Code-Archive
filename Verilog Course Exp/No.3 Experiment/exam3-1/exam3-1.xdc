set_property -dict { PACKAGE_PIN E3   IOSTANDARD LVCMOS33 } [get_ports { clk }]; #IO_L24N_T3_RS0_15 Sch=sw[0]

set_property -dict { PACKAGE_PIN T8   IOSTANDARD LVCMOS33 } [get_ports { clk_N }]; #IO_L24N_T3_RS0_15 Sch=sw[0]
